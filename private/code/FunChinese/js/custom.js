jQuery(document).ready(function () {
    $(window).load(function () {
        $(".body-wrapper").each(function () {
            ...
            $(window).scroll(function () {
                a.hasClass("bb-fixed-header") && (0 == $(this).scrollTop() || $(this).width() < 750) ? (a.removeClass("bb-fixed-header").appendTo(e), o.animate({
                    ...
                    })) : !a.hasClass("bb-fixed-header") && $(this).width() > 750 && $(this).scrollTop() > e.offset().top + e.height() - parseInt($("html").css("margin-top")) && (e.css("height", e.height()), a.css({
                        opacity: "0"
    ...
    var r = $(".product-gallery-thumblist a"),
        l = $(".product-gallery-preview > li");
    r.on("click", function (e) {
        ...
        if (a.parent().find('.incr-btn[data-action="decrease"]').removeClass("inactive"), "increase" == a.data("action")) var n = parseFloat(o) + 1;
        else if (o > 1) var n = parseFloat(o) - 1;
        else n = 1, a.addClass("inactive");
